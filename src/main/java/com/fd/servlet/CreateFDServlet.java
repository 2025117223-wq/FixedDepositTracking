...
public class CreateFDServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            // ✅ CLEAR OLD VIEW MODE DATA WHEN LOADING CREATE FD PAGE
            session.removeAttribute("viewMode");
            session.removeAttribute("viewFdID");
            System.out.println("🧹 Cleared old viewMode and viewFdID from session");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        // ✅ CLEAR OLD VIEW MODE DATA - THIS IS THE FIX!
        session.removeAttribute("viewMode");
        session.removeAttribute("viewFdID");
        System.out.println("🧹 Cleared old viewMode and viewFdID from session");
        ...
        try {
            ...
            // Store all data in session (session already obtained at top of method)
